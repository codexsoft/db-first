...
class GenerateEntitiesOperation extends Operation
{
    ...
    private function generateEntityAwareNullableTraitClassCode(ClassMetadata $metadata): string
    {
        ...
        \array_push($lines, ...[
            ...
            '',
            "trait {$shortEntityClassName}AwareNullableTrait",
            '{',
            TAB,
            TAB."private ?{$shortEntityClassName} \${$fieldName} = null;",
            TAB.'',
            TAB.'/**',
    ...
    protected function generateIdExtractors(ClassMetadataInfo $metadata): string
    {
        $lines = [];
        [
            '    /**',
