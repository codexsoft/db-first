    ...
    private function generateRepositoryBaseTrait(ClassMetadata $metadata, string $repoClass)
    {
        ...
        foreach ($metadata->fieldMappings as $key => $mapping) {
            ...
            $code = [
                ...
                '            /** @noinspection PhpUnhandledExceptionInspection */',
                "            throw new \\".\RuntimeException::class."($exceptionMessageVar);",
                '        }',
                '',
                '        /** @noinspection PhpUnhandledExceptionInspection */',
                "        throw new \\".\RuntimeException::class."('Failed to find $shortName by $key');",
                '    }',
                '    return $'.$lowerName.';',
                '}',
                '',
        ...
        foreach ($metadata->associationMappings as $associationMappingName => $associationMapping) {
            ...
            if ($associationMapping['type'] & ClassMetadataInfo::TO_ONE) {
                ...
                $code = [
                    ...
                    '',
                    '        /** @noinspection PhpUnhandledExceptionInspection */',
                    "        throw new \\".\RuntimeException::class."('Failed to find $shortName by $associationMappingName');",
                    '    }',
