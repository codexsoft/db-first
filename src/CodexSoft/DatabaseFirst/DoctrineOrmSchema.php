...
class DoctrineOrmSchema
{
    ...
    public array $doctrineTypesMap = [
        'array' => Type::TARRAY,
        'simple_array' => Type::SIMPLE_ARRAY,
        'json_array' => Type::JSON_ARRAY,
        'json' => Type::JSON,
        'bigint' => Type::BIGINT,
        'boolean' => Type::BOOLEAN,
        'datetime' => Type::DATETIME,
        'datetime_immutable' => Type::DATETIME_IMMUTABLE,
        'datetimetz' => Type::DATETIMETZ,
        'datetimetz_immutable' => Type::DATETIMETZ_IMMUTABLE,
        'date' => Type::DATE,
        'date_immutable' => Type::DATE_IMMUTABLE,
        'time' => Type::TIME,
        'time_immutable' => Type::TIME_IMMUTABLE,
