...
class SqlFormatter
{
    ...
    private const TOKEN_TYPE_WHITESPACE = 0;
    private const TOKEN_TYPE_WORD = 1;
    private const TOKEN_TYPE_QUOTE = 2;
    private const TOKEN_TYPE_BACKTICK_QUOTE = 3;
    private const TOKEN_TYPE_RESERVED = 4;
    private const TOKEN_TYPE_RESERVED_TOPLEVEL = 5;
    private const TOKEN_TYPE_RESERVED_NEWLINE = 6;
    private const TOKEN_TYPE_BOUNDARY = 7;
    private const TOKEN_TYPE_COMMENT = 8;
    private const TOKEN_TYPE_BLOCK_COMMENT = 9;
    private const TOKEN_TYPE_NUMBER = 10;
    private const TOKEN_TYPE_ERROR = 11;
    private const TOKEN_TYPE_VARIABLE = 12;

    // Constants for different components of a token
    private const TOKEN_TYPE = 0;
    private const TOKEN_VALUE = 1;
